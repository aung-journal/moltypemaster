...
function InstructionState:render()
    ...
    local textHeight = VIRTUAL_HEIGHT - headingHeight -- Remaining height for instruction text
    ...
    love.graphics.setFont(gFonts['arial-instructions'])
    love.graphics.printf(currentInstruction.text, 0 + self.offset, headingHeight + 80, textWidth, "left")
